...
> They are both sampling parameter values from the posterior distribution, simulate new data for each sampled parameter, and combine them together.
...
> Y-axis, top: posterior probability density
>
> mid: simulated probability density
>
> but: combined density of water from simulated sample
>
> Sample each point of the posterior probability make sampling distributions.
>
