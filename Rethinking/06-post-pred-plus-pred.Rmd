...
Now, the *first two* lines of the description state  the structure of the model and tell how the likelihood will be determined. The last three are all priors.
