...
What is the relationship between rainfall volume and runoff volume (both in $m^3$) for a particular stretch of a Texas highway? The code below accesses and tidies up a relevant dataset.
...
If you look at these data you'll notice that some bridges were built in the future (the data were collected in 2015) -- oops! Let's remove those too.
...
Powell and colleagues recently published [a study of predictors of primate brain size](https://royalsocietypublishing.org/doi/10.1098/rspb.2017.1765#d3e1601). We will examine some of the data they used, available at <https://sldr.netlify.app/data/primates.csv>. Variables include:
