...
> The average household income in Fiji is around 63 with high certainty.
>
...
$$\sigma \sim \text{Unif}(\text{min} = 0, \text{max} = 1)$$
...
grid_n_total_model <-
  ...
  crossing(
    ...
    # possible values to try for sd of n_total (spanning from definitely-too-small to definitely-too-big)
