...
> not capturing the true data, meaning we are missing some important
...
> The posterior predictive distribution is a bit different than the actual data, maybe we need more variables, maybe it is correct.
