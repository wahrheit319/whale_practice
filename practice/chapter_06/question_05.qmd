...
```{r}
gf_dist("beta", shape1 = 3, shape2 = 8, color = "red") |> # prior
  gf_dist("beta", shape1 = 2 + 1, shape2 = 8 + 1, color = "green") |> # likelihood
  gf_dist("beta", shape1 = 3 + 2, shape2 = 8 + 8, color = "blue") # posterior
```
