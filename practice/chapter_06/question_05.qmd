...
```{r}
gf_dist("beta", shape1 = 3, shape2 = 8, color = ~ "prior") |> # prior
  gf_dist("beta", shape1 = 2 + 1, shape2 = 8 + 1, color = ~ "likelihood") |> # likelihood
  gf_dist("beta", shape1 = 3 + 2, shape2 = 8 + 8, color = ~ "posterior") # posterior
```
