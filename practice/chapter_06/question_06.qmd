...
```{r}
gf_dist("gamma", shape = 20, rate = 5, color = ~ "prior") |> # prior
  gf_dist("gamma", shape = 1 + 1, rate = 3, color = ~ "likelihood") |> # likelihood
  gf_dist("gamma", shape = 20 + 1, rate = 5 + 3, color = ~ "posterior")  # posterior
```
